...
import Form from "./DilNawazForm";
import Table from "./DilNawazTBL";
import MeasurementForm from "./Measurements";
import MeasurementTable from "./MeasurementTable"; // Import Measurement Table
