...
const ShowroomExpenseTBL = ({ records }) => {
    const handlePrint = () => {
    ...
    return (
        <div className="overflow-x-auto bg-white shadow-md rounded-lg">
            <div className="flex justify-between items-center bg-purple-300 p-3 rounded-lg">
                <h2 className="text-black font-semibold text-xl text-center flex-grow">Daily Expense</h2>
                <button
                        ...
                        {records.length > 0 ? (
                            records.map((record, index) => (
                                <tr key={index} className="border-b border-gray-200">
                                    ...
                                    <td className="py-3 px-6 text-center no-print flex gap-2 justify-center">
                                        <button className="bg-green-400 p-2 rounded-lg hover:bg-green-500 transition">
                                            <FaEdit size={20} color="white" />
                                        </button>
                                        <button className="bg-red-400 p-2 rounded-lg hover:bg-red-500 transition">
                            ...
                            <tr><td colSpan="9" className="py-4 text-center text-gray-500">No records found</td></tr>
                        )}
                    </tbody>
                </table>
            </div>
...
export default ShowroomExpenseTBL;
