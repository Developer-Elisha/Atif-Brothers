  ...
  return (
    <div className="overflow-x-auto bg-white shadow-md rounded-lg">
      ...
      <div className="flex justify-between items-center bg-purple-300 p-3 rounded-lg">
        <h2 className="text-black font-semibold text-xl text-center flex-grow">Kapra Dealer</h2>
        <button
        ...
        <table className="min-w-full border-collapse">
          ...
          <tbody className="text-gray-700 text-sm">
            {records.length > 0 ? (
              ...
              <tr>
                <td colSpan="8" className="py-4 text-center text-gray-500">No records found</td>
              </tr>
            )}
          </tbody>
        </table>
